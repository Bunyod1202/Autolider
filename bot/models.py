...
class Text(models.Model):
    ...
    comments_sent = models.TextField(
        default="✅ Xabar yuborildi, e'tiboringiz uchun raxmat.",
    )
    ...
    you_are_not_active = models.CharField(
        max_length=255,
        default="❌ Uzr so'raymiz. Ushbu bo'lim faqatgina aktiv obunachilar uchun mavjud. Iltimos obunani aktivlashtirib so'ngra qayta urinib ko'ring.",
    )
